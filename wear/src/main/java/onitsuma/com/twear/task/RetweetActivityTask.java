 ...
 */
public class RetweetActivityTask extends AsyncTask<Long, Void, Void> implements TwearConstants {
    ...
    public RetweetActivityTask(Long tweetId) {
    ...
    protected Void doInBackground(Long... params) {
        ...
        for (Node node : nodes.getNodes()) {
            Wearable.MessageApi.sendMessage(
                    mGoogleApiClient, node.getId(), RETWEET_PATH, map.toByteArray()).setResultCallback(
